...
function CodificaArrayUTF8(array $Array): array {
 ...
 /**
 * Passa un array d'enters a format JSON.
 * @param array $Array Array que s'ha de passar a format JSON.
 * @return string Cadena amb l'array.
 */
function ArrayIntAJSON(array $Array): string {
