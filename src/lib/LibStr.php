 ...
 * @param string $Text Text a treure els accents.
...
/**
 * Suprimeix els caràcters no alfanumèrics d'un text.
 * // https://www.geeksforgeeks.org/how-to-remove-non-alphanumeric-characters-in-php/
 * NOTA: també treu els accents. Cal usar Normalitza().
 * @param string $Text Text a treure els caràcters no alfanumèrics.
 * @return string Text sense els caràcters no alfanumèrics.
 */
function SuprimeixCaractersNoAlfanumerics($Text) {
